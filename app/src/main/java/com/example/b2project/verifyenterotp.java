    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifybuttononclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!inputnumber1.getText().toString().trim().isEmpty() && !inputnumber2.getText().toString().trim().isEmpty() && !inputnumber3.getText().toString().trim().isEmpty() && !inputnumber4.getText().toString().trim().isEmpty() && !inputnumber5.getText().toString().trim().isEmpty() && !inputnumber1.getText().toString().trim().isEmpty()){
                    ...
                    if(getotpbackend!=null){
                        ...
                        Toast.makeText(verifyenterotp.this,"Please check the internet connection",Toast.LENGTH_SHORT).show();
                    }
                    Toast.makeText(verifyenterotp.this, "otp verified successfully", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(verifyenterotp.this, "please enter all the  numbers", Toast.LENGTH_SHORT).show();
            }
        }
        });
